...
<pre><code>Operation o1 = new ImageConvolutionStage1(); \\ the first sequential operation
...
<p>A few synthetic benchmarks for the shared memory skeletons are included. These can executed by the following:</p>
<ul>
<li>
...
<ul>
<li>
<p><strong>Three stage pipeline:</strong><br>
replace:<br>
...
<li>
<p><strong>Nesting pipeline in farm:</strong><br>
replace:<br>
<em>[numberOfCores]</em> with the number of processors to run the benchmark with<br>
<em>[inputSize]</em> with the number of tasks to be executed<br>
<em>[ numberOfWorkers]</em> with the total number of workers in the farm</p>
...
<li>
<p><strong>Nesting farm in pipeline:</strong><br>
replace:<br>
<em>[numberOfCores]</em> with the number of processors to run the benchmark with<br>
<em>[inputSize]</em> with the number of tasks to be executed<br>
<em>[ numberOfWorkers]</em> with the total number of workers in the farm</p>
...
<li><strong>Farm in pipeline:</strong><br>
replace:<br>
...
<li><strong>Pipeline in farm:</strong><br>
replace:<br>
<em>[numberOfCores]</em> with the number of processors to run the program, with<br>
...
<ul>
<li>
<p><strong>Edge Detection \w Pipeline Skeleton:</strong><br>
replace:<br>
...
<li>
<p><strong>Edge Detection \w Nested Skeletons:</strong><br>
replace:<br>
<em>[numberOfSystems]</em> with the number of nodes in the 		distributed system (in the multi-core mode of <em>MPJExpress</em>, this refers to the number of cores)<br>
