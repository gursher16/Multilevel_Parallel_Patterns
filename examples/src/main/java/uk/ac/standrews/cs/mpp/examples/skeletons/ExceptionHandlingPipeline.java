...
import uk.ac.standrews.cs.mpp.examples.util.PipelineOperation2;
import uk.ac.standrews.cs.mpp.examples.util.PipelineOperation3;
import uk.ac.standrews.cs.mpp.examples.util.PipelineOperationException;
