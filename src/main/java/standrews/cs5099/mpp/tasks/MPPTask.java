...
/**
 * Represents a task to be executed in parallel -- an <code>MPPtask</code> is
 * internal construct and is never exposed to users
 * 
 * @author Gursher
 *
 * @param <E>
 */
public class MPPTask implements Runnable {
	 ...
	 */
	public MPPTask(Object data, ExecutorService assignedTaskExecutor, Stack<Instruction> instructionStack) {
		this.data = data;
		this.rootTask = this;
